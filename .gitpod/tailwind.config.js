module.exports = {
  purge: [
    './packages/skijasi/commerce-theme/src/resources/**/*.vue',
    './packages/skijasi/commerce-theme/src/resources/**/*.js',
    './packages/skijasi/commerce-theme/src/resources/views/**/*.php',
