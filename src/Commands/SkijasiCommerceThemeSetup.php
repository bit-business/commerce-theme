...
namespace NadzorServera\Skijasi\Theme\CommerceTheme\Commands;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\Str;

class SkijasiCommerceThemeSetup extends Command
{
    protected $file;
    /**
     ...
     * @var string
     */
    protected $name = 'skijasi-commerce-theme:setup';
     ...
     * @var string
     */
    protected $description = 'Setup Skijasi Theme For Commerce';
    ...
    {
        Artisan::call('vendor:publish', ['--tag' => 'SkijasiCommerceTheme']);
    ...
    protected function updateWebpackMix()
    {
        ...
        mix.js("vendor/skijasi/commerce-theme/src/resources/app/app.js", "public/js/commerce-theme.js")
            .sass('vendor/skijasi/commerce-theme/src/resources/app/assets/scss/index.scss', 'public/css/commerce-theme.css')    
            .alias({
                '@': path.join(__dirname, 'vendor/skijasi')
            })
            .vue()
        EOT;
