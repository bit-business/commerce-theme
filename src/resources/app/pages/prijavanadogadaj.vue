...
if (this.isMobile) {
  ...
  methods: {
    ...
    toggleDropdown(fieldLabel, event) {
      if (event) {
        event.preventDefault();
        event.stopPropagation();
      }
      ...
      if (this.activeDropdown && this.activeDropdown !== fieldLabel) {
        this.activeDropdown = null;
      }
      
      // Toggle the clicked dropdown
      this.$nextTick(() => {
        this.activeDropdown = this.activeDropdown === fieldLabel ? null : fieldLabel;
      });
    },
