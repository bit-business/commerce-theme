<template>
  <div>
    ...
    <div class="block sm:hidden">
      ...
      <div class="mt-2 bg-white flex flex-col">
        <Link :href="route('skijasi.commerce-theme.address')" class="h-10 px-4 flex items-center gap-2 text-sm border-b">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Link :href="route('skijasi.commerce-theme.change-password')" class="h-10 px-4 flex items-center gap-2 text-sm border-b">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
