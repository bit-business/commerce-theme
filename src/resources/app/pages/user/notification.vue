    ...
    <div class="pt-8 navbar container hidden sm:grid grid-cols-profile">
      <div class="pr-8">
        ...
        <div class="mt-4 flex items-center gap-y-3 flex-wrap">
          ...
          <Link :href="route('skijasi.commerce-theme.notification')" class="w-full inline-flex items-center group text-primary">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
            </svg>
            <span class="font-semibold cursor-pointer transition-colors text-sm pl-2">Obavijesti</span>
          </Link>
        ...
        <div class="flex flex-wrap w-full">
          ...
          <template v-else>
            <div class="w-full h-full flex-col flex p-6 items-center justify-center text-gray-500">
              ...
              <span>Trenutno nemate obavijesti</span>
            </div>
          </template>
        </div>
      </div>
