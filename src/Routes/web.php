...
Route::prefix($commerce_route_prefix)
    ...
    ->group(function () {
        ...
        Route::get('/prijava-na-dogadaj/{id}/{slug}', HelpersRoute::getController('InertiaController@prijavanadogadaj'))->name('prijavanadogadaj');
        ...
        Route::get('/profile/webshop', HelpersRoute::getController('InertiaController@Webshop'))->name('webshop');
        /**
         * Legal route.
         */
